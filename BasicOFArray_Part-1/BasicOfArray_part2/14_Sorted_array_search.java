...
/*✅ Code Explanation: 💡
The method searchInSorted(int arr[], int k) performs a linear search 🔍 to check whether the element k exists in the array arr[]. It returns true if found and false otherwise.
